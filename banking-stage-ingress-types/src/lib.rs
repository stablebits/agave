...
impl Default for BankingStageFeedback {
    fn default() -> Self {
        Self {
            ...
            packets_received_by_streamer: AtomicU64::new(0),
            packets_dropped_by_sigverify: AtomicU64::new(0),
            packets_received_by_scheduler: AtomicU64::new(0),
            packets_dropped_by_scheduler: AtomicU64::new(0),
