...
impl ClientBuilder {
    pub fn new(leader_updater: Box<dyn LeaderUpdater>) -> Self {
        Self {
            ...
            initial_congestion_window: Some(crate::quic_networking::INITIAL_CONGESTION_WINDOW),
        }
    }
    ...
    pub fn initial_congestion_window(mut self, bytes: u64) -> Self {
        self.initial_congestion_window = Some(bytes);
        self
    }
